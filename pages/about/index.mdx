...
We are [Caroline Sinders](https://carolinesinders.com/) and Natalie. Together, with funding from [NDI](https://www.ndi.org/) and the [Open Technology Fund](https://www.opentech.fund/), we created this online, open source curriculum focusing on how to center human rights throughout the research, design, and development processes. It’s called the Human Rights Centered Design Curriculum and builds out an accessible, teachable methodology based on the [Secure UX Checklist](/s/Secure-UX-Checklist.pdf) created by a variety of researchers, activists, designers and security experts: Sage Cheng, Natalie, An Xiao Mina, Matt Mitchell, TTCat, Max Anderson, and Martin Shelton, with contributions from Caroline Sinders and Soraya Okuda.
...
**Natalie** is an archivist and ethnographer working at the nexus of human rights, design, and technology. She is the Founder and Executive Director of an an experienced research and development organization dedicated to the ethical collection and long-term preservation of mobile media. Using participatory research methods and co-design, she created a free, open source, mobile-to-archive preservation ecosystem, which securely and easily collects and preserves media. Her work seeks to protect communities – and their media – from efforts to chill free speech through content takedowns, privacy breaches, and data loss, while preserving it for legacy access.

Natalie complements her work with a strong theoretical background, having earned a Masters of Information Management and Systems from UC Berkeley’s School of Information and a 2019 Stanford PACS’ Digital Civil Society Lab fellowship.
...
_Our work was made possible by the [Open Technology Fund](https://www.opentech.fund/) and the [National Democratic Institute](https://www.ndi.org/). This was written in 2021 by Natalie and Caroline Sinders, Darren Clarke is the web master, Roxy Zeiher designed the site, Amira Dhalla was the senior editor, Alex Esenler was the editor, and Vani Chitkara was the content manager._
