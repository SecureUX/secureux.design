...
We are [Caroline Sinders](https://carolinesinders.com/) and Natalie C. Together, with funding from [NDI](https://www.ndi.org/) and the [Open Technology Fund](https://www.opentech.fund/), we created this online, open source curriculum focusing on how to center human rights throughout the research, design, and development processes. It’s called the Human Rights Centered Design Curriculum and builds out an accessible, teachable methodology based on the [Secure UX Checklist](/s/Secure-UX-Checklist.pdf) created by a variety of researchers, activists, designers and security experts: Sage Cheng, Natalie C, An Xiao Mina, Matt Mitchell, TTCat, Max Anderson, and Martin Shelton, with contributions from Caroline Sinders and Soraya Okuda.
